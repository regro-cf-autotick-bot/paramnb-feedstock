...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/paramnb-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/paramnb-feedstock)
...
Once the `conda-forge` channel has been enabled, `paramnb` can be installed with:

```
conda install paramnb
```

It is possible to list all of the versions of `paramnb` available on your platform with:
